...
public class MethodScannerTests
{
    ...
    {
        Assert.Contains(_publicMethod, _tested.Targets);
        Assert.Contains(_anotherPublicMethod, _tested.Targets);
    }
    ...
    public void Can_Where()
    {
        ...
        Assert.Contains(_publicMethod, _tested.Targets);
        Assert.DoesNotContain(_anotherPublicMethod, _tested.Targets);
    }
